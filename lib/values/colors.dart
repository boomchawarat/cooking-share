...
class AppColors {
  ...
  static const Color kGreen = Color.fromRGBO(76, 217, 100, 1);
  static const Color kYellow = Color(0xFFFFCC00);
  static const Color kGreyRatingStar = Color(0xFFDFE4ED);
  static const Color kSkyBlue = Color(0xFFEEF7FF);
  static const Color kDarkBackground = Color(0xFF25262E);
  static const Color kUnselectedSliderDot = Color(0xFF6A6A6A);
